...
extension Game {
    public static func CreateMock() -> Game {
        return Game(id: 0,
                        ...
                        characters: [GBObject.CreateMock(), GBObject.CreateMock()],
                        concepts: [GBObject.CreateMock(), GBObject.CreateMock()],
                        ...
                        franchises: [GBObject.CreateMock(), GBObject.CreateMock()],
                        genres: [GBObject.CreateMock(), GBObject.CreateMock()],
                        ...
                        dlcs: [GBObject.CreateMock(), GBObject.CreateMock()],
